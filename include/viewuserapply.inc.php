...
$sql = "SELECT account.firstname,account.lastname,account_id,job_id,apply_resume,apply_status FROM `applyjob` inner join account on account.acc_id = applyjob.account_id WHERE job_id = '$id'";

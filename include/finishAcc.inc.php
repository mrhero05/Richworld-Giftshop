                        ...
                        if(in_array($fileActExt,$allowed)){
                            if($fileError === 0){
                                if($fileSize < 10000000){
                                    ...
                                    $sql3 = "INSERT INTO account_complete (acc_id,age,birthday,civilstatus,caddress,gender,apply_resume,tor,letter) values ('$userId','none','none','none','none','none','none','none','none')";

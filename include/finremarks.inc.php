...
$sql = "SELECT account.firstname,account.lastname,applyjob.job_id,applyjob.apply_status,job.job_name,final_sched.finsched_acc_id from final_sched INNER JOIN account on account.acc_id = final_sched.finsched_acc_id INNER JOIN applyjob on applyjob.account_id = final_sched.finsched_acc_id INNER JOIN job on job.job_id = applyjob.job_id where applyjob.apply_status = 'Written Passed/Scheduling Final Interview'";
